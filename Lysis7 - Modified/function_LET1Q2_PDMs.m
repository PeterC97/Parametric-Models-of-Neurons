function [PDMs, Npdms] = function_LET1Q2_PDMs(x, Kest, L, Nfig, Npdms)
...
Npdms = input(['Enter a number of PDMs ' inputID ' ( <= ', num2str(L) '): ']); %3 (change when i know best)
if isempty(Npdms), 
    Npdms = 1; 
end
if Npdms>L, 
